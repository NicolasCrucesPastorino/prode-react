...
export const Tabla = () => {
  ...
  useEffect(()=> {
    firestore.getAllProdesResultados().then(r => {
  ...
  <tbody>
   {resultados.length === 0?<p>sin resultados</p>:
   resultados.map((resultado,index) => <FilaResultado index = {index} resultado={resultado}/>)
   }
  </tbody>
</table>
    </div>
