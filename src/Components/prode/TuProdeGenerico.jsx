...
export const TuProdeGenerico = (props) => {
  ...
  return (
    <div>
      ...
      <p>
        Para grabar los datos de TU PRODE apriete el botón de guardar prode al
        final.
      </p>
      <form onSubmit={handleOnSubmit}>
        ...
        <h4>
          Elija los equipos primeros y segundos de cada grupo respectivamente.
        </h4>
        ...
        <h4>
          Complete las llaves del prode de izquierda a derecha y de arriba hacia
          abajo.
        </h4>
