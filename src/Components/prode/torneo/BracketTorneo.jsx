	...
	useEffect(() => {
		const cargarResultados = async () => {
			if (consumer.userauth.rol !== ROL.ADMIN) {
				const response = await getresultadosuserprode(
							...
							<div className='participants'>
								...
								>
									...
									>
										...
										<option value={octavos['1-a']}>
											{octavos['1-a']}
										</option>
										<option value={octavos['2-b']}>
											{octavos['2-b']}
										</option>
									</select>
								</div>
					...
					<div className='matchups'>
						<div className='matchup'>
							<div className='participants'>
								<div
									className={
										'participant' + mostrarcolor('semi-a-1')
									}
								>
									<select
										onChange={handleOnChangeTorneo}
								...
								<div
									className={
										'participant' + mostrarcolor('semi-a-2')
									}
								>
									<select
										onChange={handleOnChangeTorneo}
						...
						<div className='matchup'>
							<div className='participants'>
								<div
									className={
										'participant' + mostrarcolor('semi-b-1')
									}
								>
									<select
										onChange={handleOnChangeTorneo}
								...
								<div
									className={
										'participant' + mostrarcolor('semi-b-2')
									}
								>
									<select
										onChange={handleOnChangeTorneo}
